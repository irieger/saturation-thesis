...
"""
Command line tool to render plots and image variants.

For fast changes some modules have been activated/deactivated by commenting in/out.
"""
...
# if args['image_filelist'] and not os.path.exists(args['image_filelist']):
#     print('Invalid input image list file ', args['image_filelist'])
#     sys.exit(1)
# elif args['image_filelist']:
#     image_filelist = args['image_filelist']

# if args['plot_colors'] and not os.path.exists(args['plot_colors']):
#     print('Invalid plot_colors file', args['plot_colors'])
#     sys.exit(1)
# elif args['plot_colors']:
#     plot_colors = args['plot_colors']

# if args['force_overwrite'] and os.path.exists(args['output_folder']):
